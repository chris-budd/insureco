...
const CAR_YEARS = Array.from({ length: 35 }, (_, i) => String(new Date().getFullYear() - i));

const HOME_YEARS = Array.from({ length: 226 }, (_, i) => String(new Date().getFullYear() - i));
    ...
    <div className="signup-page">
      <div className="signup-wrapper">
        ...
        <div className="signup-header-banner">
          <h1 className="signup-banner-title">Sign Up for InsureCo</h1>
        ...
        {currentStepKey === 'car' && showWarning && (
          <div className="signup-warning-banner">
            <div className="signup-warning-content">
              <Information size={16} className="signup-warning-icon" />
              <span className="signup-warning-text">This is a warning message</span>
            </div>
            <button
              className="signup-warning-dismiss"
        ...
        <div className="signup-form-card">
          <Form onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="signup-step">
                ...
                <Stack gap={6}>
                  ...
                  <DatePicker
                    ...
                    onChange={(dates) => {
                      if (dates && dates[0]) {
                        handleFieldChange('dateOfBirth', dates[0].toLocaleDateString('en-US'));
                      }
                    }}
                  >
                    <DatePickerInput
            ...
            {currentStepKey === 'address' && (
              <div className="signup-step">
                <div className="signup-step-header">
                  <h2 className="signup-step-title">Your Address</h2>
                </div>
            ...
            {currentStepKey === 'insurance' && (
              <div className="signup-step">
                <div className="signup-step-header">
                  <h2 className="signup-step-title">What Will You Insure</h2>
                </div>
                <p className="signup-step-description">
                ...
                <div className="signup-insurance-options">
                  {INSURANCE_OPTIONS.map((option) => (
                    <button
                      ...
                      onClick={() => {
                        handleFieldChange('insuranceType', option.value);
                        // Reset conditional step index if needed
                        setCurrentStep(2); // Stay on insurance type step
                      }}
                    >
                      <div className="signup-insurance-icons">
                        {option.icons.includes('car') && <CarIcon />}
                        {option.icons.includes('home') && <HomeIcon />}
                      </div>
                      <div className="signup-insurance-info">
                        <span className="signup-insurance-title">{option.title}</span>
                        <span className="signup-insurance-desc">{option.description}</span>
                      </div>
                    </button>
                  ))}
                </div>
            ...
            {currentStepKey === 'car' && (
              <div className="signup-step">
                <div className="signup-step-header">
                  <h2 className="signup-step-title">Car Details</h2>
                </div>
                ...
                <Stack gap={6}>
                  ...
                  <NumberInput
                    ...
                    min={0}
                    step={100}
                    onChange={(e, { value }) => handleFieldChange('carMileage', value)}
                    size="lg"
                  />
                  <NumberInput
                    id="carMilesPerYear"
                    ...
                    min={0}
                    step={100}
                    onChange={(e, { value }) => handleFieldChange('carMilesPerYear', value)}
                    size="lg"
                  />
                  <TextInput
                    id="carVin"
                    ...
                    onChange={(e) => handleFieldChange('carVin', e.target.value)}
                    size="lg"
                  />
                </Stack>
              </div>
            ...
            {currentStepKey === 'home' && (
              <div className="signup-step">
                <div className="signup-step-header">
                  <h2 className="signup-step-title">Property Details</h2>
                </div>
                ...
                <Stack gap={6}>
                  <Select
                    ...
                    onChange={(e) => handleFieldChange('homeType', e.target.value)}
                    size="lg"
                  >
                    <SelectItem value="" text="" />
                    {HOME_TYPES.map((type) => (
                  ...
                  <Select
                    ...
                    onChange={(e) => handleFieldChange('homeYearBuilt', e.target.value)}
                    size="lg"
                  >
                    <SelectItem value="" text="" />
                    {HOME_YEARS.map((year) => (
                  ...
                  <NumberInput
                    ...
                    min={0}
                    step={100}
                    onChange={(e, { value }) => handleFieldChange('homeSquareFeet', value)}
                    size="lg"
                  />
                  <NumberInput
                    ...
                    min={0}
                    step={1000}
                    onChange={(e, { value }) => handleFieldChange('homeEstimatedValue', value)}
                    size="lg"
                  />
                </Stack>
              </div>
