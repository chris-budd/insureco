...
const CAR_YEARS = Array.from({ length: 2025 - 1980 + 1 }, (_, i) => 2025 - i);
...
function getSteps(insuranceType) {
  const base = [
    ...
    { key: 'insurance-type', label: 'Coverage' },
    { key: 'address', label: 'Address' },
  ];

  if (insuranceType === 'car') {
    return [...base, { key: 'car-details', label: 'Car Details' }];
  }
  if (insuranceType === 'home') {
    return [...base, { key: 'home-details', label: 'Home Details' }];
  }
  ...
  return [...base, { key: 'details', label: 'Details' }];
}
...
export default function SignUpPage() {
  ...
  const steps = getSteps(insuranceType);
  ...
  const isCarDetailsStep = currentStep?.key === 'car-details';
  ...
  return (
    <div className="signup-page">
      <div className="signup-page__inner">
        ...
        {/* Warning Banner (shown on Car Details) */}
        {isCarDetailsStep && !warningDismissed && (
          <div className="signup-page__warning-banner">
            <div className="warning-banner__left">
              ...
              <span className="warning-banner__text">This is a warning message</span>
            </div>
            <button
        ...
        <div className="signup-page__form-card">
          ...
          {currentStep?.key === 'personal' && (
            <div className="signup-step">
              <div className="signup-step__heading-wrap">
                <h2 className="signup-step__heading">Personal Information</h2>
              </div>
                ...
                <DatePicker
                  ...
                  onChange={([date]) => {
                    if (date) {
                      ...
                      updateField('dateOfBirth', `${month}/${day}/${year}`);
                    }
                  }}
                >
                  <DatePickerInput
          ...
          {/* Step: Insurance Type */}
          {currentStep?.key === 'insurance-type' && (
            <div className="signup-step">
              <div className="signup-step__heading-wrap">
                <h2 className="signup-step__heading">What Will You Insure</h2>
              </div>
              <p className="signup-step__description">Which insurance coverage are you looking for</p>
              <div className="signup-step__fields">
                <div className="insurance-type-options">
                  <button
                    className={`insurance-tile ${insuranceType === 'car' ? 'insurance-tile--selected' : ''}`}
                    onClick={() => handleInsuranceSelect('car')}
                  >
                    <div className="insurance-tile__icon">{CAR_ICON}</div>
                    <div className="insurance-tile__content">
                      <span className="insurance-tile__title">Car Insurance</span>
                      <span className="insurance-tile__desc">Get comprehensive coverage for your vehicle</span>
                    </div>
                  </button>

                  <button
                    className={`insurance-tile ${insuranceType === 'home' ? 'insurance-tile--selected' : ''}`}
                    onClick={() => handleInsuranceSelect('home')}
                  >
                    <div className="insurance-tile__icon">{HOME_ICON}</div>
                    <div className="insurance-tile__content">
                      <span className="insurance-tile__title">Home Insurance</span>
                      <span className="insurance-tile__desc">Protect your most important asset for your family</span>
                    </div>
                  </button>

                  <button
                    className={`insurance-tile ${insuranceType === 'both' ? 'insurance-tile--selected' : ''}`}
                  ...
                  >
                    ...
                    <div className="insurance-tile__content">
                      ...
                      <span className="insurance-tile__desc">Insure both and get bundle savings</span>
                    </div>
                  </button>
                </div>
              </div>
          ...
          {currentStep?.key === 'address' && (
            <div className="signup-step">
              <div className="signup-step__heading-wrap">
                <h2 className="signup-step__heading">Your Address</h2>
              </div>
          ...
          {/* Step: Car Details */}
          {currentStep?.key === 'car-details' && (
            <div className="signup-step">
              <div className="signup-step__heading-wrap">
                <h2 className="signup-step__heading">Car Details</h2>
              </div>
          ...
          {/* Step: Home/Property Details */}
          {currentStep?.key === 'home-details' && (
            <div className="signup-step">
              <div className="signup-step__heading-wrap">
                <h2 className="signup-step__heading">Property Details</h2>
              </div>
          ...
          <div className="signup-page__footer">
            <div className="signup-page__footer-left">
              {isCarDetailsStep && (
                <Button
                  kind="tertiary"
